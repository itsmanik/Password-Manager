...
username_label.grid(row=2, column=2, sticky="W")
username = tkinter.Entry(font=("", 15, "normal"))
username.grid(row=3, column=2, pady=(0, 20), padx=(0, 50))
...
password_label.grid(row=4, column=2, sticky="W")
password = tkinter.Entry(font=("", 15, "normal"))
password.grid(row=5, column=2, pady=(0, 12), padx=(0, 50))
...
# Save Button
save_button = tkinter.Button(text="Save", command=lambda: save.save(platform, username, phone_number, email, password), fg="white", bg="#4D7044", font=("", 12, "normal"))
save_button.grid(row=7, column=2, sticky="ewn", pady=(0, 12), padx=(0, 50))

# Horizontal Line
canvas = tkinter.Canvas(width=750, height=70, bg="#E1E9EF", highlightthickness=0)
canvas.create_line(0, 35, 750, 35, width=2, fill="grey")
canvas.grid(row=8, column=1, columnspan=2, sticky="ew")
